...
const UpdateTimeTable = () => {
  ...
  const timeArr = ['7:00', '7:40', '8:20', '9:00', '10:00', '10:40', '11:20']
  return (
    <div className="timetable-container">
      <ToastContainer />
        ...
        <div class="timetable-img text-center">
          ...
          <select className='form-control form-control-lg' onChange={e => getClasses(e)} name="classs" >
        ...
        {toggle && <>
          ...
          <select className='form-control form-control-lg' style={{marginBottom:"1%"}} onChange={e => handleClassTeacher(e)}>
              ...
              <tbody>
                <tr>
                  ...
                  {classes && classes.Monday?.map((m, index) =>
                    <td>
                      <select onChange={e => handleChange(e, m.class_id, "Monday")} className='form-control form-control-lg' key={index}>
                        <option>--select teacher--</option>
                        {teachers && teachers?.map((teacher) =>
                ...
                <tr>
                  ...
                  {classes && classes.Tuesday?.map((m, index) =>
                    <td>
                      <select onChange={e => handleChange(e, m.class_id, "Tuesday")} className='form-control form-control-lg' key={index}>
                        <option>--select teacher--</option>
                        {teachers && teachers?.map((teacher) =>
                          <option value={teacher.teacher_name}>{teacher.teacher_name}</option>
                        )}</select>
                ...
                <tr>
                  ...
                  {classes && classes.Wednesday?.map((m, index) =>
                    <td>
                      <select onChange={e => handleChange(e, m.class_id, "Wednesday")} className='form-control form-control-lg' key={index}>
                        <option>--select teacher--</option>
                        {teachers && teachers?.map((teacher) =>
                          <option value={teacher.teacher_name}>{teacher.teacher_name}</option>
                        )} </select>
                ...
                <tr>
                  ...
                  {classes && classes.Thursday?.map((m, index) =>
                    <td>
                      <select onChange={e => handleChange(e, m.class_id, "Thursday")} className='form-control form-control-lg' key={index}>
                        <option>--select teacher--</option>
                        {teachers && teachers?.map((teacher) =>
                          <option value={teacher.teacher_name}>{teacher.teacher_name}</option>
                        )}</select>
                ...
                <tr>
                  ...
                  {classes && classes.Friday?.map((m, index) =>
                    <td><select onChange={e => handleChange(e, m.class_id, "Friday")} className='form-control form-control-lg' key={index}>
                      <option>--select teacher--</option>
                      {teachers && teachers?.map((teacher) =>
                        <option value={teacher.teacher_name}>{teacher.teacher_name}</option>
                      )} </select>
