...
const BalanceChangeHistoryThisMonth = () => {
...
BalanceChangeHistoryThisMonth.modules = {
  toolbar: [
...
BalanceChangeHistoryThisMonth.formats = [
  "header",
  "font",
  "size",
  "bold",
...
export default BalanceChangeHistoryThisMonth;
