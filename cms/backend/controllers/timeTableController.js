...
const updateClasses= (req, res) => {
  ...
  const getSpecificClass =(req, res) => {
...
const classOccurences =  (req, res) => {
  ...
  const checkClassTeacher= (req, res) => {
  ...
  const checkClassTeacherForUpdation =  (req, res) => {
...
module.exports={getClasses,updateClasses,getWeekClasses,getSpecificClass,insertClass,
checkClassMatch,
classOccurences,
checkClassTeacher,
checkClassTeacherForUpdation,
addTeacher,
getTeachers
}